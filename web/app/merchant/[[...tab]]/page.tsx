...
import { computeAlerts, computeIssues, computeSnapshot, getProducts, getStaged, shortDate, weeklyBars } from "@/lib/core";
...
export default async function MerchantPage({
  ...
  if (tab === "sohbet") {
    ...
    body = <><h1>Siparişler</h1><p className="muted" style={{ marginTop: -8, marginBottom: 16 }}>Açık konular · seed siparişler</p><OrdersView issues={issues} /></>;
  } else {
    body = (
      <>
        <h1>Özet</h1>
