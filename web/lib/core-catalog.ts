...
const SEED_BUYER_PREFS: Record<string, string> = {
  ord_0830: "[ambalaj:premium] [eko:geri] [hediye:Sevgilerle] [bahsis:40] [kupon:HOSGELDIN] [montaj:temel] [fatura:bireysel] [gizli:kapali]",
  ord_0901: "[garanti:yil1] [destek:oncelikli] [komsu:komsuya] [saat:ogle] [bahsis:20] [montaj:uzman] [fatura:bireysel] [ambalaj:standart] [eko:plastiksiz] [gizli:markasiz]",
  ...
  ord_0905: "[erisim:asansor] [taksit:6] [odeme:kart] [firma:yurtici] [montaj:temel] [fatura:kurumsal|Demo AŞ|1234567890|Kadıköy] [ambalaj:minimal] [eko:plastiksiz]",
  ord_0906: "[ambalaj:minimal] [eko:minimal] [zil:sessiz] [kupon:KARGO] [bahsis:60] [hediye] [fatura:bireysel] [gizli:markasiz]",
  ord_0907: "[gizli:fatura] [komsu:kapida] [saat:aksam] [taksit:3] [montaj:tam] [fatura:kurumsal|Qante Demo] [ambalaj:standart] [eko:geri]",
  ord_0908: "[imza:kimlik] [erisim:yardim] [paketmatik:ptt] [kupon:QANTE10] [bahsis:40] [montaj:uzman] [fatura:bireysel] [ambalaj:premium] [eko:minimal] [gizli:fatura]",
  ord_0909: "[ambalaj:premium] [eko:plastiksiz] [foto:kapida] [bildirim:whatsapp] [kupon:QANTE10] [hediye:Mutlu yıllar] [fatura:kurumsal|Atelier TR|9876543210|Beşiktaş] [gizli:kapali]",
};
