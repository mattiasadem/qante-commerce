...
const SEED_BUYER_PREFS: Record<string, string> = {
  ord_0830: "[ambalaj:premium] [eko:geri] [hediye:Sevgilerle] [bahsis:40] [kupon:HOSGELDIN] [montaj:temel] [fatura:bireysel]",
  ord_0901: "[garanti:yil1] [destek:oncelikli] [komsu:komsuya] [saat:ogle] [bahsis:20] [montaj:uzman] [fatura:bireysel] [ambalaj:standart] [eko:plastiksiz]",
  ord_0904: "[kirilgan:cift] [montaj:tam] [paketmatik:mng] [imza:gerekli] [hediye:İyi ki doğdun] [fatura:kurumsal|Nivorius GmbH|DE123456] [ambalaj:premium] [eko:geri]",
  ...
  ord_0908: "[imza:kimlik] [erisim:yardim] [paketmatik:ptt] [kupon:QANTE10] [bahsis:40] [montaj:uzman] [fatura:bireysel] [ambalaj:premium] [eko:minimal]",
  ord_0909: "[ambalaj:premium] [eko:plastiksiz] [foto:kapida] [bildirim:whatsapp] [kupon:QANTE10] [hediye:Mutlu yıllar] [fatura:kurumsal|Atelier TR|9876543210|Beşiktaş]",
};
