...
export type Order = { id: string; created_at: string; status: string; total: number; items: { product_id: string; qty: number; price: number }[]; ship_note?: string; buyer_note?: string };
